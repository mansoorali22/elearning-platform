...
public class BooksController implements Initializable {
    ...
    @FXML
    private TableColumn<CourseMaterial, String> Book;
    @FXML
	...
	void ListofSyllabus() throws IOException {
		list.clear();
		list.addAll(m.BLController().Books());
		
		
        Book.setCellValueFactory(new PropertyValueFactory<CourseMaterial, String>("title"));
